...
Class PMS_Shortcodes {
    ...
    public static function init() {
        ...
        $shortcodes = array(
            ...
            'pms-new-subscription' => __CLASS__ . '::new_subscription_form',
    ...
    /*
     * Shortcode to allow users to subscribe to new subscriptions plans
     *
     */
    public static function new_subscription_form( $atts ) {
        ...
        if( is_user_logged_in() ) {
            ...
            if( $member->is_member() ) {
                ...
                echo apply_filters( 'pms_new_subscription_form_already_a_member', do_shortcode( '[pms-account show_edit_profile="no"]' ), $atts, $member );
            ...
            echo apply_filters( 'pms_new_subscription_form_not_logged_in_message', __( 'Only registered users can see this information.', 'paid-member-subscriptions' ) );

				...
				if ( is_active_sidebar( $sidebar_id ) ) {
					...
					echo '
							...
							<div class="widget">
								...
								<div class="widget-content">
									To add custom widgets into footer, nagigate to <strong>Appearance &raquo; Widgets</strong> and add widgets into "Footer Widgets" area. Footer supports masonry widgets layout, footer columns setup, "Credits" widget area.
								</div>
							</div>
